...
(define-public genenetwork3
  (let ((commit "1e1c9d8178141469af2ca88a971a13233e88f3a8"))
    (package
      (name "genenetwork3")
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "1l901iji4nhjbvsas6r9gn8wd35d2nxsmkxaxrnh5aym03qvv75z"))))
      (native-inputs
...
(define-public genenetwork2
  (let ((commit "1c384a1fa8af178ad8547edb65ca167602b7a64f"))
    (package
      (name "genenetwork2")
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "0rjmpzc18l7wqz6dyw3xfc9r48fv6z7j009y1bvh7pixqsjr0qk2"))))
      (native-inputs
       (list graphviz))
      (propagated-inputs
