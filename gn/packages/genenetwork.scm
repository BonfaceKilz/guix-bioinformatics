...
(define-public genenetwork3
  (let ((commit "dbc548bc4bbab7dbb5c7a61f6b46a746153e2bca")
        (revision "5"))
    (package
      (name "genenetwork3")
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "0az62clmhlvb5j49xw0slkly8527hlj300ffw9fz6sjb0bvafg6s"))))
      (inputs
       (list python-click))
      (native-inputs
...
(define-public gn-auth
  (let ((commit "8679ee038a1976c2504af4c4b61af6004f54de65")
        (revision "01"))
    (package
      (name "gn-auth")
      ...
      (source
       (origin
         ...
         (hash
          (content-hash
           (base32
            "0p3nxg8dyxxhg8cv1yznmazch6wilg9irrhcn9499mqbcbn3ig9i")))))
      (build-system python-build-system)
      (arguments
       (list
        #:phases
