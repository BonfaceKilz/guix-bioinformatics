...
(define-public genenetwork3
  (let ((commit "6db3b2af8fc09999996d3acc09890a06f179c669"))
    (package
      (name "genenetwork3")
      ...
      (source
       (origin
         ...
         (sha256
          (base32
           "1ks559qa48fpdzbps1ls1g6403l8ab54fah3kgb3pw92wk5h5r2f"))))
      (native-inputs
...
(define-public genenetwork2
  (let ((commit "bc589b21d21f157ceaa4b35ca511ff2df8fbc85f"))
    (package
      (name "genenetwork2")
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "0w42z7rfsxikql49bshfm389p45g4brjyzyrxz10i8jmalsidbl5"))))
      (native-inputs
       (list graphviz))
      (propagated-inputs
